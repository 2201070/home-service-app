...
A Flutter mobile application for a Home Services Platform, allowing users to browse service categories, view available services, check service details, and book a service with a selected date, time, and address. Built as part of the Eduzah Flutter Internship (Task 1 + Task 2 + Task 3).
...
Features
Home Screen with a hero section, horizontally scrollable service categories, customer testimonials, and a modern bottom navigation bar
Service Listing screen with an animated rotating search hint and category filters
Service Details screen with ratings, reviews, full description, included services, duration, and availability
Booking screen: selected service summary, date & time selection via custom bottom sheets, address entry, notes, a booking summary, and total price
...
Light and dark theme support, fully theme-aware across every screen and bottom sheet
